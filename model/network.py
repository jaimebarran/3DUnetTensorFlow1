...
from data_reader import H53DDataLoader
# from utils.img_utils import imsave
import ops
import Dense_Transformer_Networks_3D as DTN
    ...
    def def_params(self):
        if self.conf.data_type == '3D':
            ...
            if self.conf.add_dtn == True:
                ...
                self.transform = DTN.DSN_Transformer_3D(self.dtn_input_shape,self.conf.control_points_ratio)
    ...
    def train(self):
        ...
        for train_step in range(1, self.conf.max_step+1):
            ...
            if train_step % self.conf.summary_interval == 0:
                ...
                print('Step', train_step, '----training loss', loss)
